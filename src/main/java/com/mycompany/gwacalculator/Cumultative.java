 ...
 * @author Michaelle
 */
public class Cumultative extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("CUMULATIVE GWA CALCULATOR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            jLabel11.setText(String.format("GWA: %.2f (%s)", gwa, getRemark(gwa)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cumultative.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cumultative().setVisible(true);
            }
        });
    }
