 ...
 * @author Michaelle
 */
public class GwaCalcForm extends javax.swing.JFrame {

    /**
     * Creates new form GwaCalcForm
     */
    public GwaCalcForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("ALL SUBJECTS CALCULATOR");
        ...
        jButton2.setText("CUMULATIVE GWA");
...
try {
    ...
    percentages[0] = Double.parseDouble(jTextField1.getText());
    percentages[1] = Double.parseDouble(jTextField2.getText());
    percentages[2] = Double.parseDouble(jTextField3.getText());
    percentages[3] = Double.parseDouble(jTextField4.getText());
    percentages[4] = Double.parseDouble(jTextField5.getText());
    percentages[5] = Double.parseDouble(jTextField6.getText());
    percentages[6] = Double.parseDouble(jTextField7.getText());
    percentages[7] = Double.parseDouble(jTextField8.getText());
    percentages[8] = Double.parseDouble(jTextField9.getText());
    ...
    double gwa = sum / count;
    jLabel11.setText(String.format("%.2f (%s)", gwa, getRemark(gwa)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GwaCalcForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GwaCalcForm().setVisible(true);
            }
        });
    }
